...
export default class GameScene extends Phaser.Scene {
    ...
    createTouchControls() {
        ...
        // Left Button - Shifted right
        this.leftBtn = this.add.circle(100, height - 80, 50, 0x333333, 0.5)
            .setInteractive()
            .setScrollFactor(0)
            .setDepth(1000);
        this.add.text(100, height - 80, '<', { fontSize: '40px', fill: '#fff' })
            .setOrigin(0.5)
            .setScrollFactor(0)
            .setDepth(1001);

        // Right Button - Shifted right
        this.rightBtn = this.add.circle(220, height - 80, 50, 0x333333, 0.5)
            .setInteractive()
            .setScrollFactor(0)
            .setDepth(1000);
        this.add.text(220, height - 80, '>', { fontSize: '40px', fill: '#fff' })
            .setOrigin(0.5)
            .setScrollFactor(0)
            .setDepth(1001);

        // Jump Button - Shifted left
        this.jumpBtn = this.add.circle(1280 - 220, height - 80, 50, 0x333333, 0.5)
            .setInteractive()
            .setScrollFactor(0)
            .setDepth(1000);
        this.add.text(1280 - 220, height - 80, 'J', { fontSize: '40px', fill: '#fff' })
            .setOrigin(0.5)
            .setScrollFactor(0)
            .setDepth(1001);

        // Shoot Button - Shifted left
        this.shootBtn = this.add.circle(1280 - 100, height - 80, 50, 0x333333, 0.5)
            .setInteractive()
            .setScrollFactor(0)
            .setDepth(1000);
        this.add.text(1280 - 100, height - 80, 'S', { fontSize: '40px', fill: '#fff' })
            .setOrigin(0.5)
            .setScrollFactor(0)
            .setDepth(1001);

        // Shop Toggle Button - Shifted down and left
        this.shopBtn = this.add.rectangle(1280 - 120, 100, 100, 50, 0x333333, 0.5)
            .setInteractive()
            .setScrollFactor(0)
            .setDepth(1000);
        this.add.text(1280 - 120, 100, 'SHOP', { fontSize: '24px', fill: '#fff' })
            .setOrigin(0.5)
            .setScrollFactor(0)
            .setDepth(1001);
